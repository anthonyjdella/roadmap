    ...
    return(
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                ...
                Although, it&apos;s my first React project in 3 years (previously he built a simple static-site with Gatsby), I&apos;ve got the passion and adapatbility to learn things quickly, due to my 5+ years of experience as a full-stack software developer.
