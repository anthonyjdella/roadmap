                    ...
                    <article className={stylesLifeCycle.article}>
                        <ul>
                            ...
                            <ul>
                                ...
                                <li className={stylesLifeCycle.description}>
                                    Write a new post about APIs and make it easy
                                    to understand
                                </li>
                                <li className={stylesLifeCycle.description}>
                            ...
                            <p className={stylesLifeCycle.description}>
                                Before development, I wanted to form the layout
                                for my site and create wireframes.
                            </p>
                            ...
                            <ul>
                                <li className={stylesLifeCycle.description}>
                                    ...
                                    <ul>
                                        ...
                                        >
                                            What happens when you hover over my
                                            Twitter handle?
                                        </li>
                                    </ul>
                                </li>
                                <li className={stylesLifeCycle.description}>
                                    ...
                                    <ul>
                                        ...
                                        >
                                            Hover over the Cards to see a subtle
                                            animation.
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li className={stylesLifeCycle.description}>
                                    ...
                                    <ul>
                                        ...
                                        >
                                            Look at the fancy gradient borders
                                            of each blog post (which are
                                ...
                                <li className={stylesLifeCycle.description}>
                                    ...
                                    <ul>
                                        ...
                                        >
                                            Play around with the Kanban board,
                                            but your changes won&apos;t be
                                            saved.
                                        </li>
                                    </ul>
                                </li>
                                <li className={stylesLifeCycle.description}>
                                    ...
                                    <ul>
                                        ...
                                        >
                                            Why not click on the colorful images
                                            (way down below) for a fun time?
                                        </li>
                                        <li
                                            className={
                                                stylesLifeCycle.description
                                        ...
                                        >
                                            While you&apos;re down there, see
                                            those arrows? They are virtually
                                            hand-drawn.
                                        </li>
                                    </ul>
                                </li>
